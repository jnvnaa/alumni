...
@Component({
  selector: 'app-transport-accommodation',
  templateUrl: './transport-accommodation.component.html',
  styleUrls: ['./transport-accommodation.component.css']
})
export class TransportAccommodationComponent {
  title:any;
